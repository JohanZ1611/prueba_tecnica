...
for div in divs:
    if (div.h5 is not None) and ('Cliente' in div.h5.text):
        ...
        #*se hace la condicion para validar de que sea solo los clientes y sus testimonios,luego se almacenan en sus respectivas listas creadas anteriormente
        clientes.append(cliente)
        testimonios.append(testimonio)

#* se crean y se almacenan los nombres para cada columna de la tabla
